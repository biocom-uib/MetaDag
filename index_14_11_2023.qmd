...
list_names,"/",list_names,                    "_MDAG.graphml")
```
...
p0<-ggplot(data=big_MBB_list2) + 
  ...
  scale_color_manual(values =COLOR_KINGDOM[colors_kingdom$Kingdom]) +
   ggtitle("Plot log10-identity of MBB \n  decreasing order.") +
  ylab("Log10 MBB size") + xlab("Order")
...
p1<- ggplot(data=big_MBB_list2) + 
  ...
  scale_y_continuous(trans='log10') +
  scale_color_manual(values =COLOR_KINGDOM[colors_kingdom$Kingdom]) +
   ggtitle("Plot log10-log10 of MBB size   decreasing order") +
  ylab("Log10 MBB size") + xlab("Log10 order")
...
p2<- ggplot(data=big_MBB_list2) + 
  ...
  ylim(0,1039)+ 
  ggtitle("Plot  of MBB sized  decreasing order") +
  ylab("MBB size") + xlab("Order") +
  scale_color_manual(values =COLOR_KINGDOM[colors_kingdom$Kingdom])
...
plot=ggplot(data = aux,aes=c(x=Method,y=Similarity,fill=Method)) +
  geom_boxplot()
