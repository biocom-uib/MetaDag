...
weak_componets_size_max = weak_componets_size %>%
  group_by(Organism) %>%
...
g <- ggplot(weak_componets_size_max, aes(x = Kingdom, y = csize)) +
  ...
  theme_minimal() +  # Tema minimalista con fondo blanco
  ggtitle("Size of the largest weakly connected component by Kingdom \n (Violin Plot with Jittered Points)")  # Título del gráfico
