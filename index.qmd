...
names(MSA_table)=c("Kingdom","Phylum","cluster_MSA","Number")
MSA_table=MSA_table %>% filter(Number!=0)
MSA_table=as_tibble(table(meta_taxo2$Kingdom,meta_taxo2$Phylum,meta_taxo2$clust4_MSA),names=c("Kingdom","Phylum","cluster_MSA"))
```


```{r}
knitr::kable(table(meta_taxo2$Kingdom,meta_taxo2$Phylum,meta_taxo2$clust4_Mun))
```
