...
URL: <https://bioinfo.uib.es/metadag/handleExperiment/0c982fc3-a45f-3645-b0b9-989a0425da6a>
...
table(clust5_MSA,meta_taxo$Kingdom)
```


```{r}
clust6_MSA=cutree(hc_MSA,6)
table(clust6_MSA,meta_taxo$Kingdom)
```
