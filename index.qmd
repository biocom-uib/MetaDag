...
URL: [http://bioinfo.uib.es/metadag/results?uuid=ff15c187-62e7-37c2-96a7-c824f7eab671](http://bioinfo.uib.es/metadag/results?uuid=ff15c187-62e7-37c2-96a7-c824f7eab671)
...
knitr::kable(data.frame("List of dir and files",
                        type=paste(dir(path_exp),c(rep("Data file",2),
                       rep("Directory",2),
                       rep("Data file",6),
                       "Directory"),sep="; ")))
```
...
```{r}
library(igraph)
gg_mDAG=read.graph(paste0(path_exp,"Individuals/hsa/hsa_mDAG.graphml"),format = "graphml")
summary(gg_mDAG)
barplot(table(igraph::degree(gg_mDAG,mode="all")),
              ylim=c(0,350),col="blue",
              main="Frequency of nodes degree",
              ylab="Frequency",xlab="degree")

gg_core_mDAG=read.graph(
  paste0(path_exp,"Global/core/core_mDAG.graphml"), format = "graphml")

gg_core_RC=read.graph(
...
vertex
V(gg_mDAG)
CC1=induced_subgraph(gg_mDAG, vids=vertex)
summary(CC1)
```
