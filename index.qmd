...
Mun_heat_1<- Heatmap(matrix = Sim_Mun_mDAG, 
             column_title="Similarity mDag Munkres Method Eukaryote Kingdoms",
...
dff<-meta_taxo %>% filter(Kingdom=="Animals") %>% select(Phylum,Freq_Phylum) %>%   as.data.frame() %>% select(Phylum)
...
MSA_heat_2 <- Heatmap(matrix =
                      ...
                      column_title="Similarity mDag Munkres Animals by Phyla",
                      col=rev(viridis(256)),
                      cluster_rows = FALSE,
                      ...
                      left_annotation = 
                        rowAnnotation(df = dff,
                                      col = colorsP,                                      show_annotation_name=c(FALSE),
                                      show_legend =FALSE
                                      ))
